...
namespace GCD_Test_Project
{
    ...
    public class GCDAlgorithmsTest
    {
        ...
        public void FindGCDEuclidTest1()
        {
            ...
            int c = 1204;
            int expected = 86;
            int actual = GCDAlgorithms.FindGCDEuclid(a, b, c); Assert.AreEqual(expected, actual);
        }
        [TestMethod()]
        public void FindGCDEuclidTest2()
        {
            ...
            int d = 430;
            int expected = 86;
            int actual = GCDAlgorithms.FindGCDEuclid(a, b, c, d); Assert.AreEqual(expected, actual);
        }
        [TestMethod()]
        public void FindGCDEuclidTest3()
        {
            ...
            int e = 258;
            int expected = 86;
            int actual = GCDAlgorithms.FindGCDEuclid(a, b, c, d, e); Assert.AreEqual(expected, actual);

...
namespace StressTest
{
    ...
    public class StressTestCase
    {
        ...
        /// </summary>
        private StressTestCase() : this(Material.StainlessSteel, CrossSection.IBeam, 4000, 20, 15) { }
        ...
        private StressTestCase(Material girderMaterial, CrossSection crossSection, int lengthInMm, int heightInMm, int widthInMm)
        {
